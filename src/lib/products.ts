...
const products: Product[] = [
  ...
  },
  {
    ...
    price: 2600.0,
    videoUrl: 'https://www.youtube.com/embed/OQIdxHhdWio',
    images: ['/images/Juice-Machine-Dispenser.png'],
    descImage: '/images/RR-food-singflep.jpg',
    description: `Perfect for serving colorful bubble tea and fresh juices.`,
    category: 'Machine',
    specs: [
      { key: 'Canisters', value: '2' },
      { key: 'Capacity', value: '12L x 2' },
      { key: 'Cooling', value: 'Compressor-based' },
      { key: 'Power', value: '380W' },
    ],
  },
  {
    id: 19,
    ...
    price: 2900.0,
    videoUrl: 'https://www.youtube.com/embed/fuPX8mjeb-E',
    images: ['/images/Special-Machine.png'],
    descImage: '/images/RR-food-singflep.jpg',
    description: `Fully-featured RR Special Machine designed for high-performance beverage vending.`,
    category: 'Machine',
    specs: [
      { key: 'Canisters', value: '6' },
      { key: 'Power Consumption', value: '2.0kW' },
      { key: 'Output', value: 'Up to 180 cups/hour' },
      { key: 'Dimension', value: '520 x 750 x 820mm' },
    ],
  },
  {
    id: 20,
    ...
    price: 2700.0,
    videoUrl: 'https://www.youtube.com/embed/fuPX8mjeb-E',
    images: ['/images/Athlantic.png'],
    descImage: '/images/RR-food-singflep.jpg',
    description: `Stylish and compact Athlantic machine ideal for small to medium businesses.`,
    category: 'Machine',
    specs: [
      { key: 'Canisters', value: '4' },
      { key: 'Power Consumption', value: '1.6kW' },
      { key: 'Output', value: '130 cups/hour' },
      { key: 'Dimension', value: '470 x 670 x 750mm' },
    ],
  }

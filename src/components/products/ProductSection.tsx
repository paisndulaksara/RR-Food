...
const premixes = [
  ...
  { name: 'RR Tea', image: '/images/prod.png', slug: 'rr-tea' },
  { name: 'RR Ginger Tea', image: '/images/prod.png', slug: 'rr-ginger-tea' },
  { name: 'Hot Chocolate', image: '/images/prod.png', slug: 'hot-chocolate' },
  { name: 'RR Cardemom', image: '/images/prod.png', slug: 'rr-cardemom' },
  { name: 'Ginger Milk Tea', image: '/images/prod.png', slug: 'ginger-milk-tea' },
  { name: 'Masala Tea', image: '/images/prod.png', slug: 'masala-tea' },
  { name: 'Strawberry Tea', image: '/images/prod.png', slug: 'strawberry-tea' },
  { name: 'Cinnamon Tea', image: '/images/prod.png', slug: 'cinnamon-tea' },
  { name: 'Lemongrass Tea', image: '/images/prod.png', slug: 'lemongrass-tea' },
];

    ...
    <section className="py-16 bg-white dark:bg-black">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-16">
          {/* Text */}
          <div>
            <h2 className="text-2xl md:text-3xl font-bold mb-2 dark:text-white">Our Story</h2>
            <p className="text-sm uppercase text-gray-500 mb-4 dark:text-white">THE HIGH STRESS FAVORITE</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          {/* Text */}
          <div>
            <h2 className="text-2xl md:text-3xl font-bold mb-2 dark:text-white">Who We Are ?</h2>
            <p className="text-sm uppercase text-gray-500 mb-4 dark:text-white">THE HIGH STRESS FAVORITE</p>
            <p className="text-gray-700 leading-relaxed dark:text-white">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
              Pellentesque habitant morbi tristique senectus et netus et malesuada 
